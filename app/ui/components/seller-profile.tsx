...
export default async function SellerProfile() {
  ...
  return (
    <div className="grid-cols-2 lg:grid">
      <div className="flex items-center justify-center justify-around lg:col-span-2">
        <Image
      ...
      <article className={`${Seller.sellerStory}`}>
        <h2>My Story</h2>
        <p>
          Lena, a passionate crafter, opened an Etsy store to share her handmade
          jewelry. Each piece, inspired by nature, told a unique story.
          Customers adored her intricate designs and heartfelt notes. As orders
          poured in, Lena little shop thrived, turning her hobby into a
          blossoming, joyful business.
        </p>
      </article>
      ...
      <article className={`${Seller.sellerProducts} lg:col-span-2`}>
        <h2>Products</h2>
        <section className="grid-cols-3 md:grid lg:grid-cols-5">
